...
import com.example.hibe_demo.Entity.QuestionTranslation;
import com.example.hibe_demo.Entity.QuestionType;
import com.example.hibe_demo.Repository.AppLanguageRepository;
...
public class appstarter implements CommandLineRunner {
    ...
    public appstarter(QuestionRepository questionRepository, AppLanguageRepository appLanguageRepository) {
...
//        addDeu();
    ...
    private void addEn() {
        ...
        appLanguageRepository.save(englishLanguage);
    }
    private void addTr() {
        Language TrLanguage = new Language();
        TrLanguage.setCode("Tr");
        TrLanguage.setName("Turkish");
        appLanguageRepository.save(TrLanguage);
    }
    private void addDeu() {
        Language DeuLanguage = new Language();
        DeuLanguage.setCode("Deu");
        DeuLanguage.setName("Deutsch");
        appLanguageRepository.save(DeuLanguage);
    }

    private void Question1() {
        QuestionTranslation questionTranslation = new QuestionTranslation();
        questionTranslation.getCorrectAnswers().add("hello");
        questionTranslation.getIncorrectAnswers().add("bye");
        questionTranslation.getIncorrectAnswers().add("aufwiesehen");
        questionTranslation.getIncorrectAnswers().add("gule gule");
        questionTranslation.setLanguages("En");
        questionTranslation.setQuestion("what is greeting in english languages");

        QuestionTranslation qt2 = new QuestionTranslation();
        qt2.getCorrectAnswers().add("corect fr");
        qt2.getIncorrectAnswers().add("inc fr1");
        qt2.getIncorrectAnswers().add("inc fr2");
        qt2.getIncorrectAnswers().add("inc fr3");
        qt2.setLanguages("Fr");
        qt2.setQuestion("what is greeting in english languages fr q ");
        ...
        question1.getQuestionTranslations().add(questionTranslation);
        question1.getQuestionTranslations().add(qt2);
